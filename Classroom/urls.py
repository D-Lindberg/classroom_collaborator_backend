...
from .views import current_user, UserList, all_reviews_by_user,all_reviews_by_professor, EventList, EventDetail, NewEvent,ProfileDetail, AlertList, AlertDetail, get_sections_for_current_user, NewNotes, ProfessorList, NewProfessor, NewSection, SectionStudents
...
urlpatterns = [
    ...
    path('sections/', ProfessorList.as_view(), name='section_list'),
