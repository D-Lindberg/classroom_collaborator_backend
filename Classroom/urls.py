...
from .views import (current_user, all_reviews_by_user,
                    all_reviews_by_professor, EventList, EventDetail, NewEvent,
                    AlertList, AlertDetail, get_sections_for_current_user,
                    all_sections, ProfileView, register,
                    add_current_user_to_section, new_section, AlertList,
